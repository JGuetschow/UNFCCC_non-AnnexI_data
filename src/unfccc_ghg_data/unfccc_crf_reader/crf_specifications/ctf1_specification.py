...
CTF1 = {
    "Table7": {
        ...
        "sector_mapping": [
            ...
            ["Agriculture", ["3", f"KYOTOGHG ({gwp_to_use})"], 1],
            ["Forestry/LULUCF", ["4", f"KYOTOGHG ({gwp_to_use})"], 1],
            ["Waste management/waste", ["5", f"KYOTOGHG ({gwp_to_use})"], 1],
            ["Other (specify)", ["\\IGNORE", f"KYOTOGHG ({gwp_to_use})"], 1],
            ["\\C-CHE\\ Sector 6", ["6", f"KYOTOGHG ({gwp_to_use})"], 2],
            [
                "\\C-CHE-ITA-LTU-LVA\\ Indirect CO2",
                ["M.Memo.IndCO2", f"KYOTOGHG ({gwp_to_use})"],
                2,
            ],
            [
                "\\C-DNK\\ Indirect CO2 (for projections in sectors)",
                ["M.Memo.IndCO2", f"KYOTOGHG ({gwp_to_use})"],
                2,
            ],
            [
                "\\C-FIN\\ Indirect CO2 emissions",
                ["M.Memo.IndCO2", f"KYOTOGHG ({gwp_to_use})"],
                2,
            ],
            [
                "\\C-NLD\\ Carbon Capture and Storage (CCS)",
                ["1.C", f"KYOTOGHG ({gwp_to_use})"],
                2,
            ],
            ["\\C-NZL\\ Tokelau", ["6.NZL-TKL", f"KYOTOGHG ({gwp_to_use})"], 2],
            ...
            ["\\C-CHE-LVA-NLD\\ Indirect CO2", ["M.Memo.IndCO2", "CO2"], 2],
            [
                "\\C-DNK\\ Indirect CO2 (for projection in CO2)",
                ["M.Memo.IndCO2", "CO2"],
                2,
            ],
            [
                "\\C-DEU-ESP-ITA\\ Unspecified mix of HFCs and PFCs",
                ["M.0.EL", f"UnspMixOfHFCsPFCs ({gwp_to_use})"],
                2,
            ],
    ...
    "Table9": {
        ...
        "sector_mapping": [
            ...
            ["NF3", ["M.0.EL", f"NF3 ({gwp_to_use})"], 1],
            ["Other (specify)", ["\\IGNORE", "\\IGNORE"], 1],
            ["\\C-CHE\\ Indirect CO2", ["M.Memo.IndCO2", "CO2"], 2],
            [
