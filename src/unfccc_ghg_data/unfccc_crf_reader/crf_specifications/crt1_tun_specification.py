...
CRT1_TUN = {
    ...
    "Table1.A(a)s2": {
        ...
        "sector_mapping": [
            ...
            # ["nan", ["\\IGNORE", "\\IGNORE"], 3],
            ["Liquid fuels", ["1.A.2.g.viii.3", "Liquid"], 3],
            ["Solid fuels", ["1.A.2.g.viii.3", "Solid"], 3],
            ["Gaseous fuels (6)", ["1.A.2.g.viii.3", "Gaseous"], 3],
            ["Other fossil fuels (7)", ["1.A.2.g.viii.3", "OtherFF"], 3],
            ["Peat (8)", ["1.A.2.g.viii.3", "Peat"], 3],
            ["Biomass (3)", ["1.A.2.g.viii.3", "Biomass"], 3],
        ],
        "entity_mapping": {
            "EMISSIONS CH4": "CH4",
            "EMISSIONS CO2 (2)(3)": "CO2",
