"""Read Bosnia and Herzegovina's BURs, NIRs, NCs

Scripts and configurations to read Bosnia and Herzegovina's submissions to the UNFCCC.
...
.. code-block:: bash
    ...
    poetry run doit country_info country=BIH
