"""
Read South Korea's 2025 Inventory from Excel file
"""
...
from unfccc_ghg_data.unfccc_reader.Republic_of_Korea.config_KOR_INV2025 import (
    cat_codes,
...
if __name__ == "__main__":
    ...
    # ###
    input_folder = (
        downloaded_data_path / "non-UNFCCC" / "Republic_of_Korea" / "2025-Inventory"
    )
    output_folder = extracted_data_path / "non-UNFCCC" / "Republic_of_Korea"
    if not output_folder.exists():
        output_folder.mkdir()

    output_filename = "KOR_2025-Inventory_2025_"

    inventory_file = (
        "National_greenhouse_gas_inventory_(1990_2023)(2006_guidelines).xlsx"
    )
    years_to_read = range(1990, 2023 + 1)

    sheets_to_read = ["온실가스", "CO2", "CH4", "N2O", "HFCs", "PFCs", "SF6", "NF3"]
    cols_to_read = range(1, 2023 - 1990 + 3)
    ...
    meta_data = {
        ...
        "&menuId=36&boardId=88&boardMasterId=2&boardCategoryId="
        "&pagerOffset=",
        "rights": "",
        "contact": "mail@johannes-guetschow.de",
        "title": "Republic of Korea: National Greenhouse Gas Inventory Report 2025",
    ...
    for sheet in sheets_to_read:
        ...
        df_current = pd.read_excel(
            ...
            sheet_name=sheet,
            skiprows=rows_to_read[sheet][0] - 1,
            nrows=rows_to_read[sheet][1] - rows_to_read[sheet][0] + 1,
