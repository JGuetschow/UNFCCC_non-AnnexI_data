...
from unfccc_ghg_data.unfccc_reader.Taiwan.config_twn_nir2025 import (
    add_coords_cols,
    basket_copy,
    cat_code_regexp,
    cat_conversion,
...
if __name__ == "__main__":
    ...
    # configuration
    # ###
    input_folder = downloaded_data_path / "non-UNFCCC" / "Taiwan" / "2025_NIR"
    output_folder = extracted_data_path / "non-UNFCCC" / "Taiwan"
    if not output_folder.exists():
        output_folder.mkdir()

    output_filename = "TWN_inventory_2025_"
    inventory_file = (
        "2025%20Republic%20of%20China%20National%20Greenhouse%20Gas%20"
        "Inventory%20Report%20(Report%20Summary).pdf"
    )
