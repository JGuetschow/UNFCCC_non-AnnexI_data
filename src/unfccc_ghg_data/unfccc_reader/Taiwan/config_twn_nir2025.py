...
page_defs = {
    ...
    "7": {
        "table_areas": ["34,761,563,112"],
        "split_text": False,
        "flavor": "stream",
    },
    "8": {
        "table_areas": ["37,476,564,49"],  # first part of table
        "split_text": False,
        "flavor": "stream",
    },
    "9": {
        "table_areas": ["34,766,562,545", "34,265,565,53"],
        "split_text": False,
        "flavor": "stream",
    },
    "10": {
        "table_areas": ["36,761,564,333"],
        "split_text": False,
        "flavor": "stream",
    },
    "11": {
        "table_areas": ["35,752,567,269"],
        "split_text": False,
        "flavor": "stream",
    },
    "13": {
        "table_areas": ["35,752,564,436"],
        "split_text": False,
        "flavor": "stream",
    },
    "14": {
        "table_areas": ["37,744,564,51"],
        "split_text": False,
        "flavor": "stream",
    },
    "15": {
        "table_areas": ["36,766,564,419"],
        "split_text": False,
        "flavor": "stream",
    },
    "16": {
        "table_areas": ["35,736,565,56"],
        "split_text": False,
        "flavor": "stream",
    },
    "17": {
        "table_areas": ["35,769,563,456"],
        "split_text": False,
        "flavor": "stream",
    },
    "18": {
        "table_areas": ["34,482,565,48"],
        "split_text": False,
        "flavor": "stream",
    },
    "19": {
        "table_areas": ["34,764,564,534"],
        "split_text": False,
        "flavor": "stream",
    },
    "21": {
        "table_areas": ["37,753,565,264"],
        "split_text": False,
        "flavor": "stream",
    },
}
...
table_defs = {
    ...
    "ES2.3": {  # 1990-2023 Methane Emissions in Taiwan
        "tables": [4, 5],
        "rows_to_fix": {},
        "index_cols": ["GHG Emission Sources and Sinks"],
        "wide_keyword": "GHG Emission Sources and Sinks",
    ...
    "ES2.4": {  # 1990-2023 Nitrous Oxide Emissions in Taiwan
        "tables": [6, 7],
        "fix_cats": {
            0: {
    ...
    "ES2.5": {  # 1990-2023 Fluoride-Containing Gas Emissions in Taiwan
        "tables": [8],
        "fix_cats": {},
        "rows_to_fix": {},
        "index_cols": ["GHG Emission Sources and Sinks"],
    ...
    "ES3.1": {  # 1990-2023 Greenhouse Gas Emission in Taiwan by Sector
        "tables": [9],
        "rows_to_fix": {},
        "index_cols": ["GHG Emission Sources and Sinks"],
        "wide_keyword": "GHG Emission Sources and Sinks",
    ...
    "ES3.2": {  # 1990-2023 Greenhouse Gas Emissions Produced by Energy Sector in Taiwan
        "tables": [10, 11],
        "rows_to_fix": {},
        "index_cols": ["GHG Emission Sources and Sinks"],
        "wide_keyword": "GHG Emission Sources and Sinks",
    ...
    "ES3.3": {  # 1990-2023 Greenhouse Gas Emissions Produced by Industrial Process
    ...
    "ES3.4": {  # 1990-2023 Greenhouse Gas Emissions Produced by Agriculture Sector in Taiwan
        "tables": [14, 15],
        "rows_to_fix": {},
        "index_cols": ["GHG Emission Sources and Sinks"],
        "wide_keyword": "GHG Emission Sources and Sinks",
        ...
        "unit": "ktCO2eq",
        "cat_codes_manual": {
            "Total CO2 Emission": "3",
            "Total CH4 Emission": "3",
            "Total N2O Emission": "3",
            "Total Emission From Agriculture Sector": "3",
        },
        "drop_rows": [
            "3.F Field Burning of Agricultural Residues",  # more sign. digits for some
            # years for N2O in table ES2.4
        ],
    },
    "ES3.6": {  # 1990-2023 Greenhouse Gas Emissions in Taiwan by Waste Sector
        "tables": [16],
        "rows_to_fix": {
            0: {
        ...
        "drop_rows": [
            "5.B Solid Waste Biological Disposal",  # more sign. digits for some
            # years for CH4 in table ES2.3
        ],
    },
}
...
meta_data = {
    "references": "https://www.cca.gov.tw/en/information-service/publications/national-ghg-inventory-report/13123.html",
    "rights": "",
    "contact": "mail@johannes-guetschow.de",
    "title": "2025 Republic of China - National Greenhouse Gas Report",
...
cat_conversion = {
    ...
    "aggregate": {
        ...
        # "4": {
        #     "sources": ["4.A", "4.B", "4.C", "4.D"],  # needed for CO2  where only 5.C is present
        #     # "name": "Aggregate sources and non-CO2 emissions sources on land",
        # },
        "M.AG.ELV": {
            "sources": ["3.C"],
