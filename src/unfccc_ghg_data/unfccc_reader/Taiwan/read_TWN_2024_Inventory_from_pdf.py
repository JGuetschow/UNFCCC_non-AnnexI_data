...
from unfccc_ghg_data.unfccc_reader.Taiwan.config_twn_nir2024 import (
    add_coords_cols,
    basket_copy,
    cat_code_regexp,
    cat_conversion,
...
if __name__ == "__main__":
    ...
    # configuration
    # ###
    input_folder = downloaded_data_path / "non-UNFCCC" / "Taiwan" / "2024_NIR"
    output_folder = extracted_data_path / "non-UNFCCC" / "Taiwan"
    if not output_folder.exists():
        output_folder.mkdir()

    output_filename = "TWN_inventory_2024_"
    inventory_file = (
        "2024 Republic of China National Greenhouse Gas Inventory "
        "Report (Report Summary).pdf"
    )
