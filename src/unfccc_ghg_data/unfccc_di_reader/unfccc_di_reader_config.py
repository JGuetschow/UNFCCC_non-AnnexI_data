"""
Configuration for UNFCCC DI reader

This file contains configuration for the conversion of non-AnnexI data from the
UNFCCC DI interface to the primap2 format.

It also contains the configuration for the conversion of BUR_DI categories to
the IPCC2006_PRIMAP categorization. Country specific configuration for downscaling
and sector and gas aggregation is contained as well.
"""
...
cat_code_regexp = (
    r"(?P<code>^(([0-9][A-Za-z0-9\.]{0,10}[0-9A-Za-z]))|([0-9]))[" r"\s\.].*"
)
...
di_to_pm2if_template_ai = {
    ...
    "coords_value_mapping": {
        "entity": {
            ...
            "Unspecified mix of HFCs and PFCs (AR4GWP100)": "UnspMixOfHFCsPFCs (AR4GWP100)",
    ...
    "filter_remove": {
        ...
        "entity_wrong_unit": {"gas": ["Unspecified mix of HFCs and PFCs"]},
